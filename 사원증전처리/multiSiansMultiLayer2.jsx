// /**
//  * 데이터셋 행마다 완성 디자인을 새 아트보드에 배치
//  *   · 열당 PER_COL(10)개를 **아래**로 쌓고
//  *   · 11번째부터는 **오른쪽 옆 열**로 이동해 다시 아래로
//  *   · 겹침 없이 가로·세로 격자 배치
...
//     /* 3) 열·행 오프셋 계산 */
//     var row = d % PER_COL,                       // 0–9
//         col = Math.floor(d / PER_COL);           // 0,1,2,…
//     var dx  = col * (AB_W + GAP),                // → 오른쪽
//         dy  = row * (AB_H + GAP);                // ↓ 아래쪽
